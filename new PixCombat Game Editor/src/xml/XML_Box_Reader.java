...
public class XML_Box_Reader implements ContentHandler {
	...
	public static void main(String... args) 
	{
		...
		try {
			...
			XML_Box_Reader ch = new XML_Box_Reader();
		...
		if (readingAnimation == true) {
			...
			if (readingBoxList == true) {
				if (readingBox == true) {
					...
					System.out.println("Loaded BoundaryRectangle with id " + id + " with height: " + height  + " width: " +
					width + " and coords: (" + x +"," +y + ")");
				} else {
					readingBoxList = false;
					System.out.println("Loaded BoxList " + localName
